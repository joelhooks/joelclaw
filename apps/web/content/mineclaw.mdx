...
I've been building [JoelClaw](https://github.com/joelhooks/joelclaw) for months now — a personal AI operating system that runs on a Mac Mini in my office, talks to me on Telegram, processes my email, watches webhooks, writes to a personal data server, and occasionally drafts articles while I sleep.
...
But if you keep building, you might end up with something remarkable. And the process itself is **Fun**. Capital F intentional.

## The substrate is clay

The best tools feel like raw material. Not a finished product you consume, but a medium you shape.

[Vim was like this in 2013](/blog/2013/04/09/getting-to-know-vim/). I stripped out all the dotfiles I'd accumulated — someone else's config, someone else's opinions about what plugins I needed — and started building up my own setup line by line. That tipping point where you finally understand your editor, how it works, what options are available. That's not productivity. That's *craft*.

[Self-hosting is like this now](/self-hosting/). Kubernetes on a Mac Mini, 80TB of network storage, 10G ethernet because editing video directly from the NAS is cool af. The Jared Palmers of the world look at this and ask "y tho?" The answer is the same answer it's always been: because building things feels good, and understanding your infrastructure means you own it instead of renting it from someone who might ruin it next quarter.
...
## The homelab is a world

JoelClaw, the homelab, the [AT Protocol agent network](https://github.com/joelhooks/atproto-agent-network) — same idea. Exploring, playing, building, and occasionally stepping back to admire the work.
...
The journey is fuckin' amazing and satisfying in itself.
