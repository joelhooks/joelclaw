---
title: "Extending Pi with Custom Tools and Widgets"
...
Pi is an agent harness. It runs tools, renders output, manages sessions. But the interesting part is what happens when you extend it — when you give the agent new capabilities that didn't exist before.
