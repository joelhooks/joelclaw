...
|-----|-------|--------|------|
| [0001](0001-adopt-architecture-decision-records.md) | Adopt architecture decision records | implemented | 2026-02-14 |
...
| [0003](0003-joelclaw-over-openclaw.md) | Build joelclaw instead of deploying OpenClaw | implemented | 2026-02-14 |
| [0004](0004-atproto-federation-native-app.md) | AT Protocol as bedrock + native iPhone app | implemented | 2026-02-14 |
...
| [0008](0008-loop-retrospective-and-skill-evolution.md) | Loop Retrospective and Skill Evolution | implemented | 2026-02-14 |
| [0009](0009-rename-igs-cli-to-joelclaw.md) | Rename igs CLI to joelclaw | implemented | 2026-02-15 |
| [0010](0010-system-loop-gateway.md) | System Loop (OpenClaw Gateway) | superseded by 0018 | 2026-02-15 |
| [0011](0011-redis-backed-loop-state.md) | Redis-Backed PRD State for Agent Loops | implemented | 2026-02-14 |
| [0012](0012-planner-generates-prd.md) | Planner Generates PRD from Goal | implemented | 2026-02-14 |
| [0013](0013-llm-judge-evaluation.md) | LLM-Powered Judge Evaluation | implemented | 2026-02-14 |
| [0014](0014-agent-memory-workspace.md) | Agent Memory Workspace | superseded by 0021 | 2026-02-14 |
| [0015](0015-loop-architecture-tdd-roles.md) | Loop Architecture TDD Roles | implemented | 2026-02-14 |
| [0016](0016-loop-idempotency-guards.md) | Loop Idempotency Guards | implemented | 2026-02-14 |
| [0017](0017-parallel-story-execution.md) | Parallel Story Execution | deferred | 2026-02-14 |
| [0018](0018-pi-native-gateway-redis-event-bridge.md) | Pi-native gateway with Redis event bridge | implemented | 2026-02-14 |
| [0019](0019-event-naming-past-tense.md) | Rename events to past-tense notifications | implemented | 2026-02-15 |
...
| [0021](0021-agent-memory-system.md) | Comprehensive agent memory system (supersedes 0014, 0020) | accepted | 2026-02-15 |
| [0022](0022-webhook-to-system-event-pipeline.md) | Webhook to system event pipeline | superseded | 2026-02-15 |
| [0023](0023-docker-sandbox-for-agent-loops.md) | Docker sandbox for agent loops | implemented | 2026-02-15 |
| [0024](0024-taxonomy-enhanced-session-search.md) | Taxonomy-enhanced session search | deferred | 2026-02-16 |
| [0025](0025-k3s-cluster-for-joelclaw-network.md) | k3s cluster for joelclaw network | implemented | 2026-02-16 |
| [0026](0026-background-agents-via-inngest.md) | Background agents via Inngest | deferred | 2026-02-16 |
...
| [0028](0028-inngest-rig-alignment-with-sdk-skills.md) | Align Inngest rig with SDK best practices | implemented | 2026-02-16 |
| [0029](0029-replace-docker-desktop-with-colima.md) | Replace Docker Desktop + k3d with Colima + Talos | implemented | 2026-02-17 |
...
| [0032](0032-kubernetes-storage-ceph-rook-vs-seaweedfs.md) | K8s persistent storage: Ceph Rook vs SeaweedFS vs local-path | deferred | 2026-02-17 |
...
| [0035](0035-gateway-session-routing-central-satellite.md) | Central + satellite session routing for gateway events | implemented | 2026-02-17 |
...
| [0037](0037-gateway-watchdog-layered-failure-detection.md) | Layered watchdog for gateway heartbeat failure detection | implemented | 2026-02-17 |
| [0038](0038-embedded-pi-gateway-daemon.md) | Embed pi as a library in a joelclaw gateway daemon | implemented | 2026-02-17 |
...
| [0040](0040-google-workspace-via-gogcli.md) | Google Workspace Access via gogcli | implemented | 2026-02-18 |
...
| [0045](0045-task-management-ports-and-adapters.md) | Task Management via Ports and Adapters | implemented | 2026-02-18 |
| [0046](0046-things-cli-typescript-port.md) | TypeScript Things CLI via joelclaw Tasks Subcommand | withdrawn | 2026-02-18 |
| [0047](0047-todoist-as-conversation-channel.md) | Todoist as Async Conversation Channel | implemented | 2026-02-18 |
| [0048](0048-webhook-gateway-system.md) | Webhook Gateway for External Service Integration | implemented | 2026-02-18 |
| [0049](0049-gateway-tui-via-websocket.md) | Gateway TUI via WebSocket | implemented | 2026-02-18 |
| [0050](0050-gateway-session-resume-and-codex-model.md) | Gateway session resume via fixed file path and codex model pinning | implemented | 2026-02-18 |
| [0051](0051-tailscale-funnel-as-public-ingress.md) | Tailscale Funnel as Public Ingress for Webhooks | implemented | 2026-02-18 |
| [0052](0052-email-port-hexagonal-architecture.md) | Email Port — Hexagonal Architecture with Dual Adapters | implemented | 2026-02-18 |
| [0053](0053-event-prompts-and-agent-triage.md) | Event-emitter prompts and the Agency triage principle | implemented | 2026-02-18 |
...
| [0057](0057-skill-pack-distribution.md) | Skill Pack Distribution — Install from Source | implemented | 2026-02-19 |
...
| [0088](0088-nas-backed-storage-tiering.md) | NAS-Backed Storage Tiering | accepted | 2026-02-21 |
...
| [0090](0090-o11y-triage-loop.md) | Autonomous O11y Triage Loop | implemented | 2026-02-21 |
...
| [0121](0121-imsg-rpc-socket-daemon.md) | iMessage Channel via imsg-rpc FDA Sidecar on macOS | accepted | 2026-02-24 |
...
| [0129](0129-automated-x-posting-strategy.md) | Automated X Posting Strategy | proposed | 2026-02-24 |
| [0130](0130-slack-channel-integration.md) | Slack Channel Integration | accepted | 2026-02-24 |
| [0131](0131-unified-channel-intelligence-pipeline.md) | Unified Channel Intelligence Pipeline | proposed | 2026-02-24 |
