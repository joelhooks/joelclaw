...
> "CTA: Read Kathy Sierra's Badass"
...
Samuel Hulick was the primary collaborator on translating Kathy Sierra's framework into something operational. **249 mentions of "value path" in the graph.** This was the strategic spine.
...
UbD was the system underneath everything. **173 mentions of "UbD" plus 80 of the full name.** Three stages, applied to every course, every club, every portfolio project:
...
Amy Hoy and Alex Hillman brought the backwards planning methodology and Sales Safari research technique. **32 mentions of Amy Hoy, 34 of 30x500.**
...
This was the operational manifestation of all the above threads. **50+ mentions in the graph.** A facilitated cohort experience designed with UbD, powered by value paths, aimed at the "Stand Out & Get Hired" outcome.
...
These were Knowledge Hydrant pattern in action — small groups studying great literature together. The evolution to portfolio clubs added the performance task layer (UbD Stage 2) and the value path direction.
...
Tummeling comes from Heather Gold — the tummeler is a Yiddish role, the person at a party who makes sure everyone's having a good time, draws out the quiet people, keeps energy flowing. It's the Motivated Moderator from [Kerievsky's patterns](/knowledge-hydrant-patterns).
...
In 2026, Kent C. Dodds independently arrived at the same metaphor: D&D for building apps, where he plays the DM, exercises are campaigns, and battles are learners planning with an agent.
...
Joshua Kerievsky (Knowledge Hydrant) → Study group patterns
    ↓
Joel (Knowledge Adventure Club) → "It's a workshop. A book club. A D&D campaign."
    ↓
Kent (2026) → "D&D for building apps. I play the DM."
```

The framework exists. It was tested with real cohorts at egghead. The missing piece was always the platform — the thing that makes the DM role scalable. An agent that can play Motivated Moderator, track individual learner progress through the value path, and serve up the right Opening Question at the right time.

That's what we're building now.

---

_Source: Joel's Roam Research graph, 2019-2024 egghead era. 1,400+ relevant blocks across value paths, UbD, portfolio clubs, book clubs, and the adventure pattern._
