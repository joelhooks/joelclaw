...
> **🌱 This is a draft.** The single-node migration happened and works. I'm still thinking through the multi-node story — where the control plane lives and what runtime replaces k3d when a second machine needs to join.
