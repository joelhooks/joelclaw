...
I started there too. Then I got curious about something: _what if there was already a protocol that handled identity, typed data, and real-time events?_
...
_Previous: [Why I'm building my own AI system (for fun)](/why-i-built-my-own-ai-system). Next: the 4-layer memory architecture._
