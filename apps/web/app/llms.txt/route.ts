...
export function GET() {
  const lines = [
    ...
    "## Markdown access",
    "",
    "All posts are available as clean human markdown by appending .md to the URL.",
    `Example: ${SITE_URL}/building-my-own-openclaw.md`,
    "",
    "Agent-complete markdown is available via .agent.md and preserves <AgentOnly> blocks.",
    `Example: ${SITE_URL}/building-my-own-openclaw.agent.md`,
    "",
    ".agent.md includes an agent context preamble with content type,",
