...
### 5b. Video/Media Embed

If the source URL is a YouTube video (youtube.com or youtu.be), add an embed component immediately after the title heading, before the body:

<YouTubeEmbed url="{source-url}" />

This renders an embedded video player on the cool page. Do this for ALL video sources.
...
If the source is a YouTube/video URL, insert this line immediately after the title and before body paragraphs:
<YouTubeEmbed url="{source-url}" />
