...
// maturin SMB shares over the literal tailnet IP (see endpoint-resolver nas-placement)
const NAS_NVME_MOUNT = NAS_NVME_ROOT;
const NAS_NVME_SRC = "//joel@100.102.65.115/fast";
const THREE_BODY_MOUNT = "/Volumes/services";
const THREE_BODY_SRC = "//joel@100.102.65.115/services";
