...
Instead of hardcoded color values, use **semantic colors** that describe the _purpose_ of a color rather than its appearance. Semantic colors automatically adapt to light/dark mode and accessibility settings.
