...
SATELLITE_DOCS_TYPESENSE_URL="${DOCS_TYPESENSE_URL:-${JOELCLAW_DOCS_TYPESENSE_URL:-http://joels-mac-studio.tail7af24.ts.net:8110}}"
...
upsert_env_var "$ENV_FILE" "DOCS_TYPESENSE_URL" "$SATELLITE_DOCS_TYPESENSE_URL"
