...
const KNOWN_MODEL_ALIASES: Record<string, string> = {
  ...
  "gpt-5.4-codex": "openai-codex/gpt-5.4",
  "gpt-5.4-codex-spark": "openai-codex/gpt-5.4",
  "openai-codex/gpt-5.3-codex": "openai-codex/gpt-5.4",
  "gpt-5.3-codex": "openai-codex/gpt-5.4",
  "openai-codex/gpt-5.3-codex-spark": "openai-codex/gpt-5.4",
  "gpt-5.3-codex-spark": "openai-codex/gpt-5.4",
  "openai-codex/gpt-5.2-codex-spark": "openai-codex/gpt-5.4",
  "gpt-5.2-codex-spark": "openai-codex/gpt-5.4",
