...
- Current honest limit: full-mode runtime startup is earned, and the main false-nonterminal pattern is now understood as recursive self-dogfood rather than compose bring-up. The remaining proof is to rerun the canary on the guarded path and keep terminal truth honest
