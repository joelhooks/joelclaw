# Agent setup for `joelclaw`

This is a deepsec scanning workspace. Project `joelclaw` was just registered
(target: `..`). Setup is incomplete — `data/joelclaw/INFO.md`
...
2. **Fill in `data/joelclaw/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id joelclaw
